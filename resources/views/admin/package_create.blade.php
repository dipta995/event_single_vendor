    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('add_new_product') }}">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control" name="discount" id="inputFirstName" type="number" min="0" placeholder="Enter your category name" />
